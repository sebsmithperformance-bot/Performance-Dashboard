...
/** §4 S&C Change drill-down: coach-selected KPI over a chosen basis, athlete
 *  distribution, current-vs-baseline values, athlete list. */
export function ScChangeDetail({ dataset, date }: { dataset: DashboardDataset; date: string }) {
  ...
  const segments = [
    { key: 'improved', label: 'Improved', count: view.counts.improved, color: 'var(--status-good)' },
    {
      key: 'unchanged',
