...
/** Section wrapper: the horizontal sub-tab row + routed pane (§5). The page
 *  title lives in the page-control bar; the sub-tab row reinforces the sidebar
 *  tree for fast in-section movement. Sub-tab order honors the layout config. */
